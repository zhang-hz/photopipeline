...
pub struct NodeSchemaResponse {
    ...
    pub gui_schema: serde_json::Value,
}

/// Convert prost_types::Struct to serde_json::Value manually.
...
pub async fn list_plugins(
    ...
    Ok(entries
        ...
        .map(|e| PluginEntry {
            ...
            tags: e.tags,
            requires_pixel_access: e.requires_pixel_access,
            requires_network: e.requires_network,
            requires_filesystem: e.requires_filesystem,
