        ...
        var plugins = new ObservableCollection<PluginInfo>
        {
            new()
            {
                ...
                ParameterSchemas =
                {
                    new ParameterSchema
                    {
                        ...
                        DefaultValue = "AMaZE", Description = "Demosaicing algorithm"
                    },
                    new ParameterSchema
                    {
                        Name = "border", DisplayName = "Border Handling",
                        ParameterType = ParameterType.Integer,
                        DefaultValue = 3, MinValue = 0, MaxValue = 8,
                        Description = "Pixels to crop from border"
                    }
                }
            },
            new()
            {
                ...
                ParameterSchemas =
                {
                    new ParameterSchema
                    {
                        Name = "ev", DisplayName = "Exposure (EV)",
                        ParameterType = ParameterType.Float,
                        DefaultValue = 0.0, MinValue = -5.0, MaxValue = 5.0,
                        Step = 0.01, Unit = "EV", DecimalPlaces = 2,
                        Description = "Exposure adjustment in stops"
                    },
                    new ParameterSchema
                    {
                        Name = "highlight_recovery", DisplayName = "Highlight Recovery",
                        ParameterType = ParameterType.Boolean,
                        DefaultValue = true,
                        Description = "Attempt to recover clipped highlights"
                    }
                }
            },
            new()
            {
                ...
                ParameterSchemas =
                {
                    new ParameterSchema
                    {
                        ...
                        ParameterType = ParameterType.Integer,
                        DefaultValue = 5500, MinValue = 2000, MaxValue = 50000,
                        Unit = "K", Description = "Color temperature in Kelvin"
                    },
                    new ParameterSchema
                    {
                        Name = "tint", DisplayName = "Tint",
                        ParameterType = ParameterType.Float,
                        DefaultValue = 0.0, MinValue = -150.0, MaxValue = 150.0,
                        Step = 0.1, DecimalPlaces = 1,
                        Description = "Green/magenta tint adjustment"
                    }
                }
            },
            new()
            {
                ...
                ParameterSchemas =
                {
                    ...
                    new ParameterSchema
                    {
                        ...
                        ParameterType = ParameterType.Enum,
                        EnumValues = new ObservableCollection<object> { "Standard", "Raw", "JPG", "High ISO" },
            ...
            new()
            {
                ...
                ParameterSchemas =
                {
                    ...
                    new ParameterSchema
                    {
                        ...
                        ParameterType = ParameterType.Float,
                        DefaultValue = 1.0, MinValue = 0.3, MaxValue = 5.0,
                        Step = 0.1, DecimalPlaces = 1, Unit = "px",
                        Description = "Sharpening radius in pixels"
                    }
                }
            }
        };
