...
pub type memory_callback      = unsafe extern "C" fn (data: *mut c_void, file: *const c_char, func: *const c_char);
pub type exif_parser_callback = unsafe extern "C" fn (data: *mut c_void, tag: c_int, tag_type: c_int, len: c_int, ord: c_uint, ifp: *mut c_void);
pub type data_callback        = unsafe extern "C" fn (data: *mut c_void, file: *const c_char, offset: c_int);
pub type progress_callback    = unsafe extern "C" fn (data: *mut c_void, stage: LibRaw_progress, iteration: c_int, expected: c_int) -> c_int;
