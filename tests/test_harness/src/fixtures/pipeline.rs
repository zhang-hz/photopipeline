...
pub fn hdr_pipeline() -> PipelineTemplate {
    PipelineTemplate {
        ...
        nodes: vec![
            ...
            TemplateNode {
                id: "lens".into(),
                plugin: "transform.lens_correction".into(),
