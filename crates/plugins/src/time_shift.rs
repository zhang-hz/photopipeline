                ...
                fields: vec![
                    ParameterField {
                        ...
                        field_type: ParameterType::Enum {
                            options: vec![
                                EnumOption {
                                    value: "UTC".into(), label: "UTC".into(),
                                    description: Some("Coordinated Universal Time".into()),
                                    icon: None, tags: vec!["utc".into()], recommended: true,
                                },
                                EnumOption {
                                    value: "local".into(), label: "Local".into(),
                                    description: Some("System local timezone".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "America/New_York".into(), label: "America/New_York".into(),
                                    description: Some("Eastern Time (US)".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Europe/London".into(), label: "Europe/London".into(),
                                    description: Some("Greenwich Mean / British Summer Time".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Europe/Paris".into(), label: "Europe/Paris".into(),
                                    description: Some("Central European Time".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Asia/Tokyo".into(), label: "Asia/Tokyo".into(),
                                    description: Some("Japan Standard Time".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Asia/Shanghai".into(), label: "Asia/Shanghai".into(),
                                    description: Some("China Standard Time".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Australia/Sydney".into(), label: "Australia/Sydney".into(),
                                    description: Some("Australian Eastern Time".into()),
                                    icon: None, tags: vec![], recommended: false,
                                },
                                EnumOption {
                                    value: "Pacific/Auckland".into(), label: "Pacific/Auckland".into(),
                        ...
                        field_type: ParameterType::Enum {
                            options: vec![
                                EnumOption {
                                    value: "UTC".into(), label: "UTC".into(),
                                    description: Some("Coordinated Universal Time".into()),
                                    icon: None, tags: vec!["utc".into()], recommended: false,
                                },
                                EnumOption {
                                    value: "local".into(), label: "Local".into(),
                                    description: Some("System local timezone".into()),
            ...
            ParameterSection {
                ...
                fields: vec![
                    ParameterField {
                        ...
                        description: Some("Add additional seconds per image in batch (for sequence correction)".into()),
                        help_url: None,
                        field_type: ParameterType::Float {
                            min: 0.0, max: 3600.0, step: 0.1, precision: 1,
                            unit: Some("s".into()), logarithmic: false,
                            style: Default::default(),
                        },
...
static GUI_SCHEMA: LazyLock<GuiSchema> = LazyLock::new(|| {
    GuiSchema {
        layout: GuiLayout::Standard {
            sections: vec![
                GuiSection { param_section_id: "time_shift".into(), title_visible: true, style: SectionStyle::Card },
                GuiSection { param_section_id: "timezone".into(), title_visible: true, style: SectionStyle::Card },
                GuiSection { param_section_id: "batch".into(), title_visible: true, style: SectionStyle::CollapsibleCard },
            ],
        },
        icon: Some("clock".into()),
...
impl TimeShiftPlugin {
    pub fn new() -> Self {
        Self { id: "photopipeline.plugins.time_shift".to_string() }
    }
}
...
impl Plugin for TimeShiftPlugin {
    ...
    fn name(&self) -> &str { "Time Shift" }
    fn version(&self) -> PluginVersion { PluginVersion::new(1, 0, 0) }
    fn category(&self) -> PluginCategory { PluginCategory::Metadata }
    fn description(&self) -> &str { "Adjust DateTimeOriginal by hours, minutes, and seconds with timezone support" }
...
static TAGS: LazyLock<Vec<String>> = LazyLock::new(|| {
    vec![
        "metadata".into(), "time".into(), "exif".into(), "datetime".into(),
        "timezone".into(), "shift".into(), "batch".into(),
    ]
});
